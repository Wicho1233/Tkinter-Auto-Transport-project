...
def generar_reporte_mal_estado_general(tr=None):
    ...
    filename = f"reportes/Reporte_Mal_Estado_Autotanques_Tara_{tr if tr else 'General'}.pdf"
    ...
    try:
        ...
        title_text = f"Reporte de Mantenimientos en Mal Estado - Autotanques Tara" + (f" (TR: {tr})" if tr else "")
