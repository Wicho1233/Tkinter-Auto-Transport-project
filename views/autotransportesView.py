...
from converter.autotransportesConverter import generar_reporte_mal_estado_general
from data.db_autotranportesRepo import *

class AutotransportesApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Sistema de Mantenimiento - Autotransportes Cardenas")
    ...
    def crear_widgets(self):
        ...
        tk.Label(main_frame, text="Autotranportes Cardenas", 
        ...
        self.tabs = {}
        adaptaciones = ["Carrocería", "Motor", "TrenMotriz", "Tolva", "Doli"]
    ...
    def crear_formulario_agregar(self):
        ...
        campos = [
            ...
            ("Adaptación/División:", "combobox", ["Carrocería", "Motor", "TrenMotriz", "Tolva", "Doli"]),
    ...
    def actualizar_campos_por_tipo(self, event=None):
        ...
        if tipo == "División":
            self.campos_formulario["adaptación/división"].config(values=["Tolva", "Doli"])
        else:
            self.campos_formulario["adaptación/división"].config(values=["Carrocería", "Motor", "TrenMotriz", "Tolva", "Doli"])
    ...
    def guardar_nuevo_mantenimiento(self):
        try:
            ...
            elif tipo == "División" and nombre in ["Tolva", "Doli"] and nombre == self.adaptacion_actual:
                self.crear_tabla(self.tabs[nombre], nombre)
    ...
    def mostrar_formulario_agregar_division(self, nombreDivision):
        """Muestra un formulario para agregar nueva división (Tolva o Doli)"""
    ...
    def seleccionar_dato(self, event):
        ...
        if self.adaptacion_actual in ["Tolva", "Doli"]:
